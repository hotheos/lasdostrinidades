...
(function () {
  ...
  const PAGES = [
    ...
    { id: 'tipo-teismo', file: '05_tipo_de_teismo.md', number: '5', title: '¿Qué tipo de teísmo articula Nicea?', short: 'Tipo de teísmo' },
    { id: 'entre-constantinopla-agustin', file: '06_entre_constantinopla_agustin.md', number: '6', title: 'Entre Constantinopla y Agustín', short: 'Pre-Agustín' },
    { id: 'quien-agustin', file: '07_quien_fue_agustin.md', number: '7', title: 'Quién fue Agustín', short: 'Quién fue Agustín' },
    { id: 'salto-agustiniano', file: '08_el_salto_agustiniano.md', number: '8', title: 'El salto agustiniano', short: 'El salto' },
    { id: 'dos-tipos', file: '09_dos_tipos_monoteismo_trinitario.md', number: '9', title: 'Los dos tipos de monoteísmo trinitario', short: 'Dos tipos' },
    { id: 'filioque', file: '10_filioque.md', number: '10', title: 'El Filioque', short: 'Filioque' },
    { id: 'problema-logico', file: '11_problema_logico.md', number: '11', title: 'El problema lógico de la Trinidad', short: 'Problema lógico' },
    { id: 'tres-tradiciones', file: '12_tres_tradiciones_hoy.md', number: '12', title: 'Tres tradiciones hoy', short: 'Tres tradiciones' },
    { id: 'implicaciones', file: '13_implicaciones_doctrina_de_dios.md', number: '13', title: 'Implicaciones para la doctrina de Dios', short: 'Implicaciones' },
    { id: 'volver-al-texto', file: '14_volver_al_texto.md', number: '14', title: 'Volver al texto: una invitación', short: 'Volver al texto' },
    { id: 'armonizaciones', file: '15_dos_trinidades_armonizaciones.md', number: '15', title: 'Las dos Trinidades: armonizaciones', short: 'Armonizaciones' },
