...
(function () {
  ...
  const PAGES = [
    ...
    { id: 'quien-agustin', file: '05_quien_fue_agustin.md', number: '7', title: 'Quién fue Agustín', short: 'Quién fue Agustín' },
    { id: 'salto-agustiniano', file: '06_el_salto_agustiniano.md', number: '8', title: 'El salto agustiniano', short: 'El salto' },
    { id: 'dos-tipos', file: '07_dos_tipos_monoteismo_trinitario.md', number: '9', title: 'Los dos tipos de monoteísmo trinitario', short: 'Dos tipos' },
    { id: 'filioque', file: '08_filioque.md', number: '10', title: 'El Filioque', short: 'Filioque' },
    { id: 'problema-logico', file: '09_problema_logico.md', number: '11', title: 'El problema lógico de la Trinidad', short: 'Problema lógico' },
    { id: 'tres-tradiciones', file: '10_tres_tradiciones_hoy.md', number: '12', title: 'Tres tradiciones hoy', short: 'Tres tradiciones' },
    { id: 'implicaciones', file: '11_implicaciones_doctrina_de_dios.md', number: '13', title: 'Implicaciones para la doctrina de Dios', short: 'Implicaciones' },
    { id: 'volver-al-texto', file: '12_volver_al_texto.md', number: '14', title: 'Volver al texto: una invitación', short: 'Volver al texto' },
    { id: 'armonizaciones', file: '13_dos_trinidades_armonizaciones.md', number: '15', title: 'Las dos Trinidades: armonizaciones', short: 'Armonizaciones' },
